const country_iata = {
    "LSZ": "(Mali) Losinj - Losinj Arpt <<Croatia (Hrvatska)>>",
    "AAR": "Aarhus <<Denmark>>",
    "ABD": "Abadan <<Iran>>",
    "AEH": "Abeche <<Chad>>",
    ...
    "ASJ": "Amami <<Japan>>",
    "AMA": "Amarillo, TX <<USA>>",
    "ADJ": "Amman, Civil - Marka Airport <<Jordan>>",
    ...
    "AOI": "Ancona <<Italy>>",
    "ALV": "Andorra La Vella H/P <<Andorra>>",
    "AXA": "Anguilla <<Anguilla>>",
    "AJN": "Anjouan <<Comoros (Comores)>>",
    "ANK": "Ankara <<Turkey>>",
    ...
    "AJU": "Aracaju <<Brazil>>",
    "GPA": "Araxos <<Greece>>",
    "ARH": "Arkhangelsk <<Russian Federation>>",
    "RLT": "Arlit <<Niger>>",
    ...
    "ASB": "Ashgabat, Ashkhabat <<Turkmenistan>>",
    "ASE": "Aspen Snowmass, CO <<USA>>",
    "ATZ": "Assiut <<Egypt>>",
    "TSE": "Astana <<Kazakstan>>",
    "ASU": "Asuncion <<Paraguay>>",
    "ASW": "Aswan, Daraw Airport <<Egypt>>",
    "ATH": "Athens <<Greece>>",
    "AHN": "Athens, GA <<USA>>",
    "HEW": "Athens, Hellinikon Airport <<Greece>>",
    "ATO": "Athens, OH <<USA>>",
    "ATL": "Atlanta, Hartsfield Atlanta Int'l Airport <<USA>>",
    "ACY": "Atlantic City, NJ <<USA>>",
    "YAT": "Attawapiskat, NT <<Canada>>",
    ...
    "AYR": "Ayr <<Australia>>",
    "BJZ": "Badajoz <<Spain>>",
    "BGW": "Bagdad, Al Muthana <<Iraq>>",
    "SDA": "Bagdad, Saddam International <<Iraq>>",
    "IXB": "Bagdogra <<India>>",
    ...
    "YVB": "Bonaventure, PQ <<Canada>>",
    "BOB": "Bora Bora <<French Polynesia>>",
    "BOD": "Bordeaux <<France>>",
    "HBH": "Borg El Arab Airport <<Egypt>>",
    "BXS": "Borrego Springs, CA <<USA>>",
    "BOS": "Boston - Logan, MA <<USA>>",
    ...
    "EZE": "Buenos Aires, Ezeiza Int'l Airport <<Argentina>>",
    ...
    "CAI": "Cairo Int'l <<Egypt>>",
    "YYC": "Calgary/Banff <<Canada>>",
    "CLO": "Cali <<Colombia>>",
    "CCJ": "Calicut <<India>>",
    "CLY": "Calvi <<France>>",
    "YCB": "Cambridge Bay <<Canada>>",
    "CBG": "Cambrigde <<United Kingdom>>",
    ...
    "CPR": "Casper, WY <<USA>>",
    "CTG": "Catagena <<Colombia>>",
    "CTA": "Catania <<Italy>>",
    "CAY": "Cayenne <<French Guayana>>",
    "CBU": "Cebu <<Philippines>>",
    ...
    "QCB": "Chiba City <<Japan>>",
    "ORD": "Chicago O'Hare Int'l Airport, IL <<USA>>",
    "CHI": "Chicago, IL <<USA>>",
    ...
    "CKG": "Chongqing <<Sichuan, China>>",
    "CHC": "Christchurch <<New Zealand>>",
    "CXI": "Christmas Line <<Iceland>>",
    "CCZ": "Chub Cay <<Bahamas>>",
    "YYQ": "Churchill <<Canada>>",
    "CFG": "Cienfuegos <<Canada>>",
    ...
    "BKL": "Cleveland, Burke Lakefront, OH <<USA>>",
    "CLE": "Cleveland, Hopkins, OH <<USA>>",
    "CBB": "Cochabamba <<Bolivia>>",
    "COK": "Cochin <<India>>",
    "COD": "Cody/Powell/Yellowstone, WY <<USA>>",
    "KCC": "Coffmann Cove, AK <<USA>>",
    ...
    "DAL": "Dallas, Love Field, TX <<USA>>",
    "DFW": "Dallas/Ft. Worth, TX <<USA>>",
    "DJO": "Daloa <<Ivory Coast>>",
    "DAM": "Damascus, International <<Syria>>",
    "DMM": "Dammam, King Fahad Int'l <<Saudi Arabien>>",
    "DAN": "Danville, VA <<USA>>",
    "DAR": "Dar es Salam (Daressalam) <<Tanzania>>",
    "DRW": "Darwin <<Australia>>",
    "DDI": "Daydream Island <<Australia>>",
    "DAY": "Dayton, OH <<USA>>",
    "DAB": "Daytona Beach, FL <<USA>>",
    "DEC": "Decatur, IL <<USA>>",
    "YDF": "Deer Lake/Corner Brook <<Canada>>",
    "DEL": "Delhi, Indira Gandhi <<India>>",
    "HAG": "Den Haag (The Hague) <<Netherlands>>",
    "DPS": "Denpasar/Bali <<Indonesia>>",
    "DEN": "Denver International Airport, CO <<USA>>",
    "DSK": "Dera Ismail Khan <<Pakistan>>",
    "EMA": "Derby (East Midlands) <<United Kingdom>>",
    "DRB": "Derby <<Australia>>",
    "LDY": "Derry (Londonderry) <<United Kingdom>>",
    "DSM": "Des Moines, IA <<USA>>",
    "DET": "Detroit City, MI <<USA>>",
    "DTT": "Detroit Metropolitan Area, MI <<USA>>",
    "DTW": "Detroit Metropolitan Wayne County Airport, MI <<USA>>",
    ...
    "ELM": "Elmira, NY <<USA>>",
    "ELY": "Ely, NV <<USA>>",
    "EDR": "Emerald <<Australia>>",
    "EMD": "Emerald <<Australia>>",
    "ENF": "Enontekioe <<Finland>>",
    "EBB": "Entebbe <<Uganda>>",
    "ERF": "Erfurt <<Germany>>",
    "ERI": "Erie, PA <<USA>>",
    "EVN": "Eriwan (Yerevan, Jerevan) <<Armenia>>",
    "EBJ": "Esbjerg <<Denmark>>",
    "ESC": "Escabana, MI <<USA>>",
    ...
    "HNN": "Frankfurt/Hahn <<Germany>>",
    "FRA": "Frankfurt/Main Int'l Airport <<Germany>>",
    ...
    "FJR": "Fujairah, Int'l Airport <<United Arab Emirates>>",
    "FUK": "Fukuoka <<Japan>>",
    "FKS": "Fukushima-shi, Fukushima Airport <<Japan>>",
    ...
    "GHB": "Govenors Harbour <<Bahamas>>",
    "GRX": "Granada <<Spain>>",
    "GBI": "Grand Bahama <<Bahamas>>",
    ...
    "GPZ": "Grand Rapids, MN <<USA>>",
    "GRZ": "Graz <<Austria>>",
    "GTF": "Great Falls, MT <<USA>>",
    "GKL": "Great Keppel Island <<Australia>>",
    "GRB": "Green Bay, WI <<USA>>",
    "LWB": "Greenbrier/Lewisburg, WV <<USA>>",
    "GSO": "Greensboro/Winston Salem, NC <<USA>>",
    ...
    "GTE": "Groote Eyeland <<Australia>>",
    "GTI": "Groote Eylandt <<Australia>>",
    "GON": "Groton/New London, CT <<USA>>",
    "GDL": "Guadalajara <<Mexico>>",
    "GSI": "Guadalcanal <<Solomon Islands>>",
    "GUM": "Guam <<Guam>>",
    "CAN": "Guangzhou (Canton) - Baiyun (White Cloud) <<Guangdong, China>>",
    "GRU": "Guarulhos Int'l - Sao Paulo <<Brazil>>",
    ...
    "CMX": "Hancock, MI <<USA>>",
    "HGH": "Hangchow (Hangzhou) <<Zhejiang, China>>",
    "HAJ": "Hannover <<Germany>>",
    "HAN": "Hanoi - Noibai <<Viet Nam>>",
    "HRE": "Harare <<Zimbabwe>>",
    "HRB": "Harbin (Haerbin) <<Heilongjiang, China>>",
    "HRL": "Harlington/South Padre Island, TX <<USA>>",
    "YHR": "Harrington Harbour, PQ <<Canada>>",
    "MDT": "Harrisburg, PA - Harrisburg Int'l <<USA>>",
    "HAR": "Harrisburg, PA - Harrisburg Skyport <<USA>>",
    "BDL": "Hartford, CT/Springfield, MA <<USA>>",
    "HDY": "Hatyai (Hat Yai) <<Thailand>>",
    "HAU": "Haugesund <<Norway>>",
    "HAV": "Havana - Jos\u00c3\u00a9 Mart\u00c3\u00ad Int'l <<Cuba>>",
    "HVR": "Havre, MT <<USA>>",
    ...
    "HNK": "Hinchinbrook Island <<Australia>>",
    "HIJ": "Hiroshima International <<Japan>>",
    "HBA": "Hobart <<Australia>>",
    "HOQ": "Hof <<Germany>>",
    "HOG": "Holguin <<Cuba>>",
    "HMH": "Home Hill <<Australia>>",
    "HOM": "Homer, AK <<USA>>",
    "ZJK": "Hong Kong - Chek Lap Kok <<Hong Kong>>",
    "HKG": "Hong Kong - Int'l Airport (HKIA) <<Hong Kong>>",
    "HIR": "Honiara Henderson Int'l <<Solomon Islands>>",
    "HNL": "Honolulu, HI <<USA>>",
    "HNH": "Hoonah, AK <<USA>>",
    "HOR": "Horta <<Portugal>>",
    "HOU": "Houston, Hobby, TX <<USA>>",
    "IAH": "Houston, Intercontinental, TX <<USA>>",
    "HUH": "Huahine <<French Polynesia>>",
    "HUX": "Huatulco <<Mexico>>",
    "HUI": "Hue - Phu Bai <<Viet Nam>>",
    "HUY": "Humberside <<United Kingdom>>",
    "HTS": "Huntington, OH <<USA>>",
    "HSV": "Huntsville, AL <<USA>>",
    "HRG": "Hurghada Int'l <<Egypt>>",
    "HON": "Huron, SD <<USA>>",
    "HWN": "Hwange National Park <<Zimbabwe>>",
    "HYA": "Hyannis, MA <<USA>>",
    "HYG": "Hydaburg, AK <<USA>>",
    "HYD": "Hyderabad - Begumpet <<India>>",
    ...
    "ILI": "Iliamna, AK <<USA>>",
    "IPL": "Imperial, CA <<USA>>",
    "ICN": "Incheon, Incheon Int'l Airport <<Korea South>>",
    ...
    "IKT": "Irkutsk <<Russia>>",
    "LSG": "Ishigaki <<Japan>>",
    "ISB": "Islamabad - Islamabad Int'l <<Pakistan>>",
    ...
    "HLP": "Jakarta - Halim Perdanakusma <<Indonesia>>",
    "JKT": "Jakarta - Kemayoran <<Indonesia>>",
    "CGK": "Jakarta - Soekarno-Hatta <<Indonesia>>",
    "JLR": "Jalandhar <<India>>",
    "JMS": "Jamestown, ND <<USA>>",
    "JHW": "Jamestown, NY <<USA>>",
    "IXW": "Jamshedpur - Sonari <<India>>",
    "JED": "Jeddah - King Abdulaziz Int'l <<Saudi Arabia>>",
    "XRY": "Jerez de la Frontera/Cadiz <<Spain>>",
    "JER": "Jersey <<United Kingdom>>",
    "JRS": "Jerusalem <<Israel>>",
    "TNA": "Jinan <<Shandong, China>>",
    "JIW": "Jiwani <<Pakistan>>",
    "JCB": "Joacaba <<Brazil>>",
    "JPA": "Joao Pessoa - Castro Pinto <<Brazil>>",
    "JKG": "Joenkoeping <<Sweden>>",
    "JOE": "Joensuu <<Finland>>",
    "JNB": "Johannesburg - Johannesburg Int'l <<South Africa>>",
    "JST": "Johnstown, PA <<USA>>",
    "JHB": "Johore Bahru <<Malaysia>>",
    "JLN": "Joplin, MO <<USA>>",
    "GJN": "Jounieh <<Lebanon>>",
    "JNU": "Juneau, AK - Juneau Int'l <<USA>>",
    "JYV": "Jyvaeskylae <<Finland>>",
    "KBL": "Kabul - Khwaja Rawash <<Afghanistan>>",
    "KOJ": "Kagoshima <<Japan>>",
    "OGG": "Kahului, HI <<USA>>",
    "KAJ": "Kajaani <<Finland>>",
    "KLX": "Kalamata <<Greece>>",
    "AZO": "Kalamazoo/Battle Creek, MI <<USA>>",
    ...
    "KAN": "Kano <<Nigeria>>",
    "QJU": "Kanpur <<India>>",
    "MCI": "Kansas City, MO - Int'l <<USA>>",
    "KHH": "Kaohsiung Int'l <<Taiwan>>",
    ...
    "KRP": "Karup <<Denmark>>",
    "ZKE": "Kaschechawan, PQ <<Canada>>",
    "KSL": "Kassala <<Sudan>>",
    "KTR": "Katherine <<Australia>>",
    "KTM": "Kathmandu - Tribhuvan <<Nepal>>",
    "MPA": "Katima Mulilo/Mpacha <<Namibia>>",
    "KHJ": "Kauhajoki <<Finland>>",
    "MKK": "Kaunakakai, HI <<USA>>",
    "KVA": "Kavalla <<Greece>>",
    "KZN": "Kazan (Ka San) <<Russia>>",
    ...
    "CCU": "Kolkata (Calcutta) - Netaji Subhas Chandra <<India>>",
    "KMQ": "Komatsu <<Japan>>",
    "KOA": "Kona, HI <<USA>>",
    ...
    "KUL": "Kuala Lumpur - Int'l Airport <<Malaysia>>",
    ...
    "KUO": "Kuopio <<Finland>>",
    "KUH": "Kushiro <<Japan>>",
    "YVP": "Kuujjuaq (FortChimo) <<Canada>>",
    "YGW": "Kuujjuarapik <<Canada>>",
    "KAO": "Kuusamo <<Finland>>",
    "KWI": "Kuwait - Kuwait Int'l <<Kuwait>>",
    "UKY": "Kyoto <<Japan>>",
    "CGN": "K\u00c3\u00b6ln, K\u00c3\u00b6ln/Bonn <<Germany>>",
    "LCG": "La Coruna <<Spain>>",
    ...
    "LDK": "Lidkoeping <<Sweden>>",
    "LGG": "Liege <<Belgium>>",
    "LIF": "Lifou <<Loyaute, Pazifik>>",
    "LIH": "Lihue, HI <<USA>>",
    "LIL": "Lille <<France>>",
    "LLW": "Lilongwe - Lilongwe International <<Malawi>>",
    "LIM": "Lima - J Chavez Int'l <<Peru>>",
    "QLI": "Limassol <<Cyprus>>",
    "LIG": "Limoges <<France>>",
    "LNK": "Lincoln, NE <<USA>>",
    "LDC": "Lindeman Island <<Australia>>",
    "LNZ": "Linz - Hoersching <<Austria>>",
    "LIQ": "Lisala <<Congo, Democratic Republic of The>>",
    ...
    "ISP": "Long Island, Islip, NY - Mac Arthur <<USA>>",
    "LRE": "Longreach <<Australia>>",
    "GGG": "Longview/Kilgore, TX <<USA>>",
    "LYR": "Longyearbyen - Svalbard <<Svalbard/Norway>>",
    "LTO": "Loreto <<Mexico>>",
    "LRT": "Lorient <<France>>",
    "LAX": "Los Angeles, CA - Int'l <<USA>>",
    ...
    "LLA": "Lulea <<Sweden>>",
    "FBM": "Lumbumbashi <<Zaire>>",
    "LUN": "Lusaka <<Zambia>>",
    "LUJ": "Lusisiki <<South Africa>>",
    "LUX": "Luxembourg <<Luxembourg>>",
    "LXR": "Luxor <<Egypt>>",
    "LWO": "Lvov (Lwow, Lemberg) <<Ukraine>>",
    "LYH": "Lynchburg, VA <<USA>>",
    "LYS": "Lyon <<France>>",
    "MST": "Maastricht/Aachen <<Netherlands>>",
    "MCP": "Macapa <<Brazil>>",
    "MFM": "Macau <<Macau, China SAR>>",
    "MCZ": "Maceio <<Brazil>>",
    "MKY": "Mackay <<Australia>>",
    "MCN": "Macon, GA <<USA>>",
    "NOP": "Mactan Island - Nab <<Philippines>>",
    "MSN": "Madison, WI <<USA>>",
    "MAA": "Madras (Chennai) <<India>>",
    "MAD": "Madrid - Barajas <<Spain>>",
    "SEZ": "Mahe - Seychelles Int'l <<Seychelles>>",
    "MAH": "Mahon <<Spain>>",
    ...
    "AGP": "Malaga <<Spain>>",
    "MLE": "Male - International <<Maledives>>",
    "MYD": "Malindi <<Kenya>>",
    "MMX": "Malmo (Malmoe) - Sturup <<Sweden>>",
    ...
    "MNL": "Manila - Ninoy Aquino Int'l <<Philippines>>",
    "ZLO": "Manzanillo <<Mexico>>",
    "MTS": "Manzini - Matsapha Int'l <<Swaziland>>",
    ...
    "MTM": "Metlakatla, AK <<USA>>",
    "MZM": "Metz <<France>>",
    "MXL": "Mexicali <<Mexico>>",
    "MEX": "Mexico City - Juarez International <<Mexico>>",
    "MFU": "Mfuwe <<Zambia>>",
    "MIA": "Miami, FL <<USA>>",
    ...
    "MSP": "Minneapolis - St. Paul Int'l Airport, MN <<USA>>",
    "MOT": "Minot, ND <<USA>>",
    ...
    "MSO": "Missula, MT <<USA>>",
    "MHE": "Mitchell, SD <<USA>>",
    "MMY": "Miyako Jima (Ryuku Islands) - Hirara <<Japan>>",
    "KMI": "Miyazaki <<Japan>>",
    "MBM": "Mkambati <<South Africa>>",
    "MFF": "Moanda <<Gabon>>",
    "MOB": "Mobile, AL - Pascagoula, MS <<USA>>",
    "MOD": "Modesto, CA <<USA>>",
    "MJD": "Moenjodaro <<Pakistan>>",
    "MGQ": "Mogadischu <<Somalia>>",
    "OKU": "Mokuti <<Namibia>>",
    ...
    "QND": "Novi Sad <<Yugoslavia>>",
    "OVB": "Novosibirsk - Tolmachevo <<Russia>>",
    "NLD": "Nuevo Laredo <<Mexico>>",
    "TBU": "Nuku'alofa - Fua'Amotu International <<Tonga>>",
    "NUE": "N\u00c3\u00bcrnberg (Nuremberg) <<Germany>>",
    "OAK": "Oakland, CA <<USA>>",
    "OAX": "Oaxaca <<Mexico>>",
    "ODE": "Odense <<Denmark>>",
    "ODS": "Odessa <<Ukraine>>",
    ...
    "KOI": "Orkney <<United Kingdom>>",
    "ORL": "Orlando Int'l Airport, FL <<USA>>",
    "ORS": "Orpheus Island <<Australia>>",
    "ITM": "Osaka - Itami <<Japan>>",
    "KIX": "Osaka - Kansai Int'l Airport <<Japan>>",
    ...
    "PBM": "Paramaribo - Zanderij Int'l <<Suriname>>",
    ...
    "PUS": "Pu San (Pusan) - Kimhae <<South Korea>>",
    "PBC": "Puebla <<Mexico>>",
    "PUB": "Pueblo, CO <<USA>>",
    ...
    "YQB": "Quebec - Quebec Int'l <<Canada>>",
    ...
    "RAR": "Rarotonga Cook <<Island>>",
    "RKT": "Ras al Khaymah (Ras al Khaimah) <<UAE>>",
    ...
    "SDS": "Sado Shima <<Japan>>",
    "MBS": "Saginaw/Bay City/Midland, MI <<USA>>",
    "SDT": "Saidu Sharif <<Pakistan>>",
    "SGN": "Saigon (Ho Chi Minh City) <<Viet Nam>>",
    "SBK": "Saint Brieuc <<France>>",
    "RUN": "Saint Denis de la Reunion <<Reunion>>",
    ...
    "SSA": "Salvador <<Brazil>>",
    "SZG": "Salzburg - W.A. Mozart <<Austria>>",
    ...
    "SAN": "San Diego - Lindberg Field Int'l, CA <<USA>>",
    "SFO": "San Francisco - Int'l Airport, SA <<USA>>",
    "SJO": "San Jose <<Costa Rica>>",
    "SJD": "San Jose Cabo <<Mexico>>",
    "SJC": "San Jose, CA <<USA>>",
    "SJU": "San Juan Perto <<Rico>>",
    "SBP": "San Luis Obisco, CA <<USA>>",
    ...
    "SKV": "Santa Katarina - Mount Sinai <<Egypt>>",
    "SMA": "Santa Maria <<Portugal>>",
    "SMX": "Santa Maria, CA <<USA>>",
    "RSA": "Santa Rosa <<Argentina>>",
    "SRB": "Santa Rosa <<Bolivia>>",
    "SRA": "Santa Rosa <<Brazil>>",
    "SDH": "Santa Rosa Copan <<Honduras>>",
    "STS": "Santa Rosa, CA <<USA>>",
    "SSL": "Santa Rosalia <<Colombia>>",
    "SRL": "Santa Rosalia <<Mexico>>",
    "SDR": "Santander <<Spain>>",
    "SCU": "Santiago - Antonio Maceo Airport <<Cuba>>",
    ...
    "OKD": "Sapporo - Okadama <<Hokkaido, Japan>>",
    "CTS": "Sapporo - Shin-Chitose Airport <<Japan>>",
    "SPK": "Sapporo <<Hokkaido, Japan>>",
    ...
    "MME": "Teesside, Durham Tees Valley <<United Kingdom>>",
    "TGU": "Tegucigalpa <<Honduras>>",
    "THR": "Tehran (Teheran) - Mehrabad <<Iran>>",
    "TLV": "Tel Aviv - Ben Gurion Int'l <<Israel>>",
    ...
    "YYZ": "Toronto - Lester B. Pearson <<Canada>>",
    "YTO": "Toronto <<Canada>>",
    ...
    "TRS": "Trieste <<Italy>>",
    "TIP": "Tripoli - Tripoli Int'l <<Libya>>",
    "TOS": "Tromsoe <<Norway>>",
    ...
    "VER": "Veracruz <<Mexico>>",
    "VEL": "Vernal, UT <<USA>>",
    "VRB": "Vero Beach/Ft. Pierce, FL <<USA>>",
    ...
    "WAW": "Warsaw <<Poland>>",
    "BWI": "Washington DC - Baltimore Washington Int'l <<USA>>",
    "IAD": "Washington DC - Dulles Int'l <<USA>>",
    ...
    "XIY": "Xi'an - Xianyang <<Shaanxi, China>>",
    "XMN": "Xiamen <<Fujian, China>>",
    "YKM": "Yakima, WA <<USA>>",
    "YAK": "Yakutat, AK <<USA>>",
    "YKS": "Yakutsk <<Russian Federation>>",
    "GAJ": "Yamagata, Junmachi <<Japan>>",
    "ASK": "Yamoussoukro <<C\u00c3\u00b4te d'Ivoire (Ivory Coast)>>",
    "YNB": "Yanbu <<Saudi Arabia>>",
    "RGN": "Yangon (Rangoon) - Mingaladon <<Myanmar (Burma)>>",
    ...
    "ZRH": "Zurich (Z\u00c3\u00bcrich) - Kloten <<Switzerland>>",
    "RAI": "\u00ef\u00bb\u00bfPraia <<Cape Verde>>"
}

function populateInput(id) {
    for (const [key, value] of Object.entries(country_iata)) {
